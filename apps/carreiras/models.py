...
class Vaga(Base):
    ...
    cod_vaga = models.CharField('Código', max_length=200, blank=False, null=False)
    ...
    descricao = models.TextField('Descrição', max_length=300, blank=False, null=False)
    escolaridade = models.ForeignKey(Escolaridade, verbose_name='Escolaridade', on_delete=models.SET_NULL, blank=True,
                                     null=True)
    tempo_experiencia = models.CharField('Tempo de experiência', max_length=200, blank=False, null=False)
...
class Candidatura(Base):
    ...
    cidade = models.CharField('Cidade', max_length=200, blank=False, null=False, default='Canoas')
    telefone = models.CharField('Telefone', max_length=15, blank=False, null=False)
    escolaridade = models.ForeignKey(Escolaridade, verbose_name='Escolaridade', on_delete=models.SET_NULL, blank=True,
                                     null=True)
    curso = models.CharField('Curso', max_length=15, blank=True, null=True)
